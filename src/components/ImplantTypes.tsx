      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {implantData.map((item, index) => (
            ...
            >
              <div className="w-14 h-14 mx-auto mb-4 relative group-hover:scale-110 transition-transform duration-300 bg-white/10 rounded-xl flex items-center justify-center">
                <Image src={item.icon} alt={item.title} width={32} height={32} className="w-8 h-8 object-contain" />
              </div>
