      ...
      <div className="bg-[var(--brand-dark)] text-white py-2 px-4 text-xs md:text-sm hidden sm:block">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span>Mon–Sat: 9:00 AM–1:00 PM & 4:00 PM–8:30 PM</span>
          </div>
          <div className="flex items-center gap-5">
            <a href="tel:+919277756167" className="hover:text-[var(--brand-gold)] transition-colors flex items-center gap-1.5">
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
              +91 9277756167
            </a>
            <span className="opacity-30">|</span>
            <a href="tel:+919638787144" className="hover:text-[var(--brand-gold)] transition-colors">+91 9638787144</a>
            <span className="opacity-30">|</span>
