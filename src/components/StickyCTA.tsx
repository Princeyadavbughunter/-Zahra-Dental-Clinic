    ...
    <div className="fixed bottom-0 left-0 right-0 bg-[var(--brand-dark)]/95 backdrop-blur-md text-white py-3 px-4 z-40 border-t border-white/10 shadow-2xl">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        <div className="hidden sm:block">
          ...
          <p className="text-[10px] text-gray-400">11,000+ patients | 600+ 5-star reviews</p>
        </div>
        <div className="flex gap-2 w-full sm:w-auto">
          ...
          <a href="tel:+919277756167" className="bg-white/10 text-white px-5 py-2 rounded-full font-bold text-xs border border-white/20 hover:bg-white/20 transition-colors flex-1 sm:flex-none text-center">
            CALL
          </a>
        </div>
      </div>
