  ...
  return (
    <footer className="bg-[var(--brand-dark)] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3">
              <a href="https://www.facebook.com/DrMohammadAbbasNoorani/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-[var(--brand-gold)] transition-all duration-300 group">
          ...
          {/* Hours */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider text-[var(--brand-gold)] mb-4">Clinic Hours</h3>
          ...
          {/* Location */}
          <div>
            <h3 className="font-bold text-sm uppercase tracking-wider text-[var(--brand-gold)] mb-4">Location</h3>
            <a
        ...
        {/* Map */}
        <div className="bg-white/5 rounded-xl overflow-hidden h-[250px] md:h-[300px] mb-10 border border-white/10">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d29381.899140505146!2d72.4979827743164!3d22.996682300000025!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e853bc6fbfe99%3A0x543b53dbd5fb398f!2sZahra%20Dental%20Clinic%20and%20Implant%20Centre!5e0!3m2!1sen!2sin!4v1775646698896!5m2!1sen!2sin"
            width="100%"
            height="100%"
            style={{ border: 0 }}
            ...
            title="Zahra Dental Clinic - Ahmedabad"
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
          <p className="text-gray-500 text-xs">&copy; {new Date().getFullYear()} Zahra Dental Clinic & Implant Centre. All rights reserved.</p>
